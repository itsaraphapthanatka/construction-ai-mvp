export const en = {
    ...
    header: {
        ...
        financialsTitle: ['Project ', 'Financials'],
        postConTitle: ['Post ', 'Construction'],
    ...
    ,
    financials: {
        subtitle: 'Finance cockpit — cash, AR/AP, WHT, and budget variance by project.',
        totalPayable: 'Total payable',
        whtCollected: 'WHT collected',
        retentionHold: 'Retention hold',
        eTaxSync: 'E-Tax sync',
        engineTitle: 'Thai Financial Engine — Auto WHT compliance',
        engineDesc:
            'Auto-calculate WHT and sync e-tax invoices. Detect missing attachments and block risky submissions.',
        auto: 'Auto',
        connected: 'Connected',
        tracking: 'Tracking',
        btnWht13: 'WHT 1% + 3%',
        ...
        budgetVariance: 'Budget variance',
        cashflowTitle: 'Cashflow — In vs Out',
        cashIn: 'Cash in',
        cashOut: 'Cash out',
        net: 'Net',
        payablesTitle: 'Top payables — due in 30 days',
        vendor: 'Vendor',
        invoice: 'Invoice',
        amount: 'Amount',
        due: 'Due',
    ...
    postCon: {
        ...
        doneBtn: 'Mark Done',
        zoneA: 'Zone A - Lobby',
        zoneB: 'Zone B - Parking',
        zoneC: 'Zone C - Pool',
        zoneD: 'Zone D - Floor 5-8',
        item1: 'Floor tiles cracked (3 points)',
        item2: 'Glass door not closing tightly',
        item3: 'Emergency lighting failure Zone B2',
        item4: 'Leakage at pool rim (2 points)',
        item5: 'Ceiling sagging in 12 units',
        item6: 'AC not cooling in 4 units',
    }
};
